...
const MONGODB_URI = 'mongodb+srv://vicorico:a57BAZHLFuqQ4c0x@cluster0.xa6kx.mongodb.net/marketz?retryWrites=true&w=majority&appName=Cluster0';
...
async function seed() {
  try {
    ...
    const Fight = mongoose.model('Fight', new mongoose.Schema({
      fighter1: String,
      fighter2: String,
      date: Date,
      category: String,
    ...
    console.log('Current fights in database:', fights);
